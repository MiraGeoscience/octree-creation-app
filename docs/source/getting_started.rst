...
Whether you are a developer or an end-user, this page will help you get started with the **octree-creation-app**.
...
Follow this link to `download from the GitHub repository <https://github.com/MiraGeoscience/octree-creation-app/archive/refs/heads/main.zip>`_.
...
A conda environment named ``octree-creation`` will be created to prevent conflicts with other software that may rely on Python.
